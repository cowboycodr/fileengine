...
if __name__ == '__main__':
    f = File(r'D:\code\dev\python-dev\pi-lang\src\utils\file_.py')
    import time
    
    for line in range(1, f.lines - 1):
        f.swap_lines(line, line + 1)
        
        f.write_to_file(r'D:\code\dev\python-dev\pi-lang\src\utils\text.txt')
        time.sleep(0.1)